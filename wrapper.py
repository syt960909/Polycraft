...
class ProcessFrame:
    ...
    def step(self, action):
        obs, reward, done, done_,info = self.env.step(action)
        return self._process_frame(obs), reward, done,done_, info
    ...
    def _process_frame(self, frame):
        ...
        img = cv2.resize(img_array, (84, 84), interpolation=cv2.INTER_AREA)
